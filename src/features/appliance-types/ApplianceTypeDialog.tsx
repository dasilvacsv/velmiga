...
interface ApplianceTypeDialogProps {
  ...
  onApplianceTypeAdded: () => void
}

export function ApplianceTypeDialog({
  open,
  onOpenChange,
  onApplianceTypeAdded,
          ...
          {showSuccess ? (
            ...
            >
              <div className="text-center space-y-3">
                ...
                <h3 className="text-lg font-medium">Type Added Successfully!</h3>
                <p className="text-muted-foreground text-sm">
                  Your new appliance type has been created
                </p>
              </div>
            </motion.div>
          ) : (
              ...
              <div className="grid gap-6 py-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Enter appliance type name"
                    required
                  />
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/50 p-3 rounded-md border border-blue-100 dark:border-blue-900 flex items-start gap-2">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300">
                    Adding an appliance type will make it available for selection when creating or editing appliances.
                  </p>
                </div>
              </div>
